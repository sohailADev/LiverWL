...
<div id="wrap">
    <div id="main" class="row" style="max-height: 1500px;">
        <div class="col-md-6 mx-auto">
            ...
            <form action="<?php echo URLROOT; ?>/Users/login" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <a type="button" href="<?php echo URLROOT; ?>/Users/register" style="background-color: #33A8E2" class="btn text-white btn-lg btn-info btn-block">No account? Register</a>
                    </div>
                </div>
